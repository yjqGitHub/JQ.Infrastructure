...
namespace JQ.Redis.StackExchangeRedis
{
    ...
    public sealed class StackExchangeRedisClient : IRedisClient
    {
        ...
        public StackExchangeRedisClient(RedisCacheOptions redisCacheOption, IBinarySerializer serializer)
        {
        ...
        {
            return _redisCacheOption.Prefix.IsNullOrWhiteSpace() ? key : $"{_redisCacheOption.Prefix}{_redisCacheOption.NamespaceSplitSymbol}{key}";
        }
